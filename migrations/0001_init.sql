...
-- 5. Merchant Network Indices Table
...
-- 9. Webhook Delivery Attempts Table
...
-- Cursor table the SOL watcher depends on
...
-- payment_path column + the constraint the ON CONFLICT needs
ALTER TABLE payments ADD COLUMN IF NOT EXISTS payment_path VARCHAR(16);
